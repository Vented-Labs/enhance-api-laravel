...
class DnsApi
{
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\DnsThirdPartyProvider[]';
        $request = $this->getDnsThirdPartyProvidersRequest($contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\DnsZone';
        $request = $this->getWebsiteDomainDnsZoneRequest($org_id, $website_id, $domain_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\DefaultDnsRecord[]';
        $request = $this->listDefaultDnsRecordsRequest($contentType);
