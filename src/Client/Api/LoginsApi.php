...
class LoginsApi
{
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\LoginMemberships';
        $request = $this->createOtpSessionRequest($otp, $contentType);
    ...
    public function createSessionWithHttpInfo($login_creds, $realm_id = null, string $contentType = self::contentTypes['createSession'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 201:
                    return $this->handleResponseWithDataType(
                        '\Vented\EnhanceApiLaravel\Client\Model\SessionResult',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\LoginsListing';
        $request = $this->getCustomerLoginsRequest($org_id, $offset, $limit, $sort_order, $sort_by, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\Login';
        $request = $this->getLoginRequest($contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\SessionsFullListing';
        $request = $this->getSessionsRequest($contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\UiPreferences';
        $request = $this->getUiPreferencesRequest($contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\UpdateLoginResult';
        $request = $this->updateLoginInfoRequest($update_login, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ValidatedPasswordRecovery';
        $request = $this->validatePasswordRecoveryRequest($secret, $contentType);
