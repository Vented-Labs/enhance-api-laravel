...
class ServersApi
{
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\WebsiteAndDomainUuid';
        $request = $this->createServerDomainRequest($server_id, $body, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ScreenshotConfig';
        $request = $this->getAppcdScreenshotConfigRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\MysqlKind';
        $request = $this->getDatabaseRoleMysqlKindRequest($server_id, $mysql_kind, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\EmailServerHostnameOverride';
        $request = $this->getEmailServerHostnameOverrideRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\FsQuotaStatus';
        $request = $this->getFsQuotaStatusRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\HttpdStatus';
        $request = $this->getHttpdStatusRequest($server_id, $role, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\InstallCmd';
        $request = $this->getInstallCmdRequest($contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\OutboundSpamScanningSettings';
        $request = $this->getOutboundSpamScanningSettingsRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\OwaspVersion';
        $request = $this->getOwaspRulesVersionRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerDiskUsage';
        $request = $this->getServerDiskUsageRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\WebsitePhpSettings[]';
        $request = $this->getServerFpmSettingsRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerGroups';
        $request = $this->getServerGroupsRequest($contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerHostnameWebsite';
        $request = $this->getServerHostnameWebsiteRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerInfo';
        $request = $this->getServerInfoRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerIowait';
        $request = $this->getServerIowaitRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerLoad';
        $request = $this->getServerLoadRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerMemoryUsage';
        $request = $this->getServerMemoryUsageRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerNetworkInterfaces';
        $request = $this->getServerNetworkInterfacesRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerNetworkStats';
        $request = $this->getServerNetworkStatsRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\GetServerRole200Response';
        $request = $this->getServerRoleRequest($server_id, $role, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\RolesInfo';
        $request = $this->getServerRolesRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerStatsFullListing';
        $request = $this->getServerStatsRequest($server_id, $start, $end, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerStatus';
        $request = $this->getServerStatusRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServerUptime';
        $request = $this->getServerUptimeRequest($server_id, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\ServersListing';
        $request = $this->getServersRequest($offset, $limit, $sort_order, $sort_by, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\UpgradableSystemPackage';
        $request = $this->getSystemPackageUpdateInfoRequest($server_id, $system_package_name, $contentType);
    ...
    {
        $returnType = '\Vented\EnhanceApiLaravel\Client\Model\PhpIni';
        $request = $this->getWebsiteFpmSettingsRequest($server_id, $website_id, $contentType);
