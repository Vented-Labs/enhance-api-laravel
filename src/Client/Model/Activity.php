...
class Activity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'org_id' => 'string',
        'kind' => '\Vented\EnhanceApiLaravel\Client\Model\ActivityKind',
        'created_at' => '\DateTime',
        'message' => 'string',
    ...
    */
     ...
     * Gets kind
     *
     * @return \Vented\EnhanceApiLaravel\Client\Model\ActivityKind
     */
     ...
     * Gets context
     *
     * @return \Vented\EnhanceApiLaravel\Client\Model\ActivityContext|null
     */
     ...
     *
     * @return \Vented\EnhanceApiLaravel\Client\Model\ActivityObject|null
     */
    ...
    public function setActivityObject($activity_object)
    {
        if (is_null($activity_object)) {
            throw new \InvalidArgumentException('non-nullable activity_object cannot be null');
        }
