...
class ImportServerDomain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        'import_server_id' => 'importServerId',
        'domain' => 'domain',
        'kind' => 'kind',
        'user' => 'user',
        'movable' => 'movable'
    ...
    protected static $setters = [
        'import_server_id' => 'setImportServerId',
        'domain' => 'setDomain',
        'kind' => 'setKind',
        'user' => 'setUser',
        'movable' => 'setMovable'
    ...
    protected static $getters = [
        'import_server_id' => 'getImportServerId',
        'domain' => 'getDomain',
        'kind' => 'getKind',
        'user' => 'getUser',
        'movable' => 'getMovable'
    ...
    {
        $this->setIfExists('import_server_id', $data ?? [], null);
        $this->setIfExists('domain', $data ?? [], null);
        $this->setIfExists('kind', $data ?? [], null);
        $this->setIfExists('user', $data ?? [], null);
        $this->setIfExists('movable', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['import_server_id'] === null) {
            $invalidProperties[] = "'import_server_id' can't be null";
        }
     ...
     * @return string
     */
    public function getImportServerId()
    {
        return $this->container['import_server_id'];
    }
    ...
    {
        if (is_null($import_server_id)) {
            throw new \InvalidArgumentException('non-nullable import_server_id cannot be null');
        }
        $this->container['import_server_id'] = $import_server_id;
     ...
     * Gets kind
     *
     * @return \Vented\EnhanceApiLaravel\Client\Model\DomainMappingKind
     */
    ...
    {
        if (is_null($movable)) {
            throw new \InvalidArgumentException('non-nullable movable cannot be null');
        }
        $this->container['movable'] = $movable;
