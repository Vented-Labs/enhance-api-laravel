 ...
 */
class Login2FA implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $openAPITypes = [
        'auth_method' => 'string',
        'pin' => 'string',
        'remember_me' => '\Vented\EnhanceApiLaravel\Client\Model\Login2FARememberMe',
    ];
     ...
     * Gets remember_me
     *
     * @return \Vented\EnhanceApiLaravel\Client\Model\Login2FARememberMe|null
     */
     ...
     * Sets remember_me
     *
     * @param  \Vented\EnhanceApiLaravel\Client\Model\Login2FARememberMe|null  $remember_me  remember_me
     * @return self
     */
