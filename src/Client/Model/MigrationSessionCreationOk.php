...
class MigrationSessionCreationOk implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ok_count', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ok_count'] === null) {
            $invalidProperties[] = "'ok_count' can't be null";
        }
    ...
    {
        return $this->container['ok_count'];
    }
    ...
    {
        if (is_null($ok_count)) {
            throw new \InvalidArgumentException('non-nullable ok_count cannot be null');
        }
        $this->container['ok_count'] = $ok_count;
     ...
     * Gets migrations
     *
     * @return \Vented\EnhanceApiLaravel\Client\Model\MigrationCreationOutcome[]
     */
