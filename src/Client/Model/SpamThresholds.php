...
/**
 * SpamThresholds Class Doc Comment
 *
 * @category Class
 * @package  Vented\EnhanceApiLaravel\Client
 * @author   OpenAPI Generator team
 ...
 */
class SpamThresholds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpamThresholds';
    ...
    {
        $this->setIfExists('greylist', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['greylist'];
    }

    /**
     * Sets greylist
     *
     * @param float|null $greylist greylist
     *
     * @return self
     */
    public function setGreylist($greylist)
    {
        if (is_null($greylist)) {
            throw new \InvalidArgumentException('non-nullable greylist cannot be null');
        }
        $this->container['greylist'] = $greylist;
