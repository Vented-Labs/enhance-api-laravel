...
/**
 * UpdateAccessToken Class Doc Comment
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAccessToken implements \JsonSerializable, ArrayAccess, ModelInterface
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateAccessToken';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ip_restricted', $data ?? [], null);
    }
     ...
     * Gets roles
     *
     * @return \Vented\EnhanceApiLaravel\Client\Model\Role[]|null
     */
     ...
     * Sets roles
     *
     * @param  \Vented\EnhanceApiLaravel\Client\Model\Role[]|null  $roles  roles
     * @return self
     */
    ...
    {
        if (is_null($ip_restricted)) {
            throw new \InvalidArgumentException('non-nullable ip_restricted cannot be null');
        }
