...
/**
 * WebServerRewrite Class Doc Comment
 *
 * @category Class
 * @package  Vented\EnhanceApiLaravel\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebServerRewrite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebServerRewrite';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('destination_file', $data ?? [], null);
    }
    ...
    */
    ...
    public function setDestinationFile($destination_file)
    {
        if (is_null($destination_file)) {
            throw new \InvalidArgumentException('non-nullable destination_file cannot be null');
        }
