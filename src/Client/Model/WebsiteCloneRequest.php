...
class WebsiteCloneRequest implements \JsonSerializable, ArrayAccess, ModelInterface
{
    ...
    protected static $attributeMap = [
        'run_wp_search_replace' => 'runWpSearchReplace',
    ...
    protected static $setters = [
        'run_wp_search_replace' => 'setRunWpSearchReplace',
    ...
    protected static $getters = [
        'run_wp_search_replace' => 'getRunWpSearchReplace',
    ...
    {
        $this->setIfExists('run_wp_search_replace', $data ?? [], null);
        ...
        $this->setIfExists('new_website', $data ?? [], null);
    }
     ...
     * @return bool|null
     */
    public function getRunWpSearchReplace()
    {
        return $this->container['run_wp_search_replace'];
    }
    ...
    {
        if (is_null($run_wp_search_replace)) {
            throw new \InvalidArgumentException('non-nullable run_wp_search_replace cannot be null');
        }
        $this->container['run_wp_search_replace'] = $run_wp_search_replace;
     ...
     * Gets new_website
     *
     * @return \Vented\EnhanceApiLaravel\Client\Model\WebsiteCloneNewWebsite|null
     */
    public function getNewWebsite()
    {
        return $this->container['new_website'];
    }
    ...
    {
        if (is_null($new_website)) {
            throw new \InvalidArgumentException('non-nullable new_website cannot be null');
        }
        $this->container['new_website'] = $new_website;
