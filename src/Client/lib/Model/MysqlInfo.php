 ...
 */
class MysqlInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MysqlInfo';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mysql_kind'] === null) {
            $invalidProperties[] = "'mysql_kind' can't be null";
        }
     ...
     * Sets mysql_kind
     *
     * @param \Vented\EnhanceApiLaravel\Client\Model\MysqlKind $mysql_kind mysql_kind
     *
     * @return self
     */
